...
[![docs][docs-img]][docs-url] [![docs][docs-dev-img]][docs-dev-url] [![CI][ci-img]][ci-url] [![runic][runic-img]][runic-url] [![codecov][codecov-img]][codecov-url]
...
[docs-url]: https://JuliaManifolds.github.io/ManifoldMakie.jl/stable/
